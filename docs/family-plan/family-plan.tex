...
Videos from phones will be accepted alongside photos and play inside the album. Short clips, up to about a minute, play silently in the photo grid when you tap or hover, the way stories do on social apps. Longer videos open in the viewer with normal controls. Everything is converted so that it plays on any phone or computer, and the original file is kept untouched.
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \node[box,text width=5.6cm,fill=mist,minimum height=2.3cm,align=left] (home) at (0,0) {\textbf{Stays on our own computer}\\[3pt]\scriptsize
      \textbullet\ The photos and videos themselves\\
...
\begin{enumerate}[leftmargin=2em,itemsep=4pt]
  \item \textbf{Short videos.} The plan treats clips under about a minute as ``quick'' videos that play silently in the grid. Is that what we want, or should all videos behave the same?
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \foreach \x/\c/\t/\d in {
      ...
      3.5/ph2/Videos/{and uploads that resume},
