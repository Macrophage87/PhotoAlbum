...
export default async function NewActivityPage({ params }: PageProps<"/trips/[slug]/activities/new">) {
  ...
  return (
    <div className="max-w-2xl">
      ...
      <ActivityForm action={createActivity.bind(null, slug)} submitLabel="Add activity" timezone={trip.timezone} initial={{ title: "", type: "HIKE", start: `${day}T09:00`, end: `${day}T12:00`, description: "", participants: [] }} members={members} />
    </div>
  );
}
