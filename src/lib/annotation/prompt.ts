...
- caption: "Sam's first swim at the lake house" (not "A child swimming in a lake")
- caption: "Lobster rolls on the mail boat" (not "People eating on a boat")
...
Anything you cannot determine is null or an empty list. Never invent a place, an occasion or a name that is neither visible nor in the notes. Never include the words "image" or "photo" in the caption. Answer only with the structured record.`;
