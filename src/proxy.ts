...
export const config = {
  matcher: ["/upload", "/admin/:path*", "/trips/new", "/trips/:slug/settings", "/trips/:slug/import", "/photos", "/photos/:path*", "/collections/new", "/collections/:slug/settings", "/privacy", "/review", "/people", "/people/:path*"],
};
