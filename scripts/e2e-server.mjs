...
const env = { ...process.env, DATABASE_URL: dbUrl,
  ...
  GOOGLE_OAUTH_CLIENT_ID: "e2e-client", GOOGLE_OAUTH_CLIENT_SECRET: "e2e-secret", TOKEN_ENCRYPTION_KEY: Buffer.alloc(32, 7).toString("base64"), GOOGLE_ACCOUNTS_URL: `http://127.0.0.1:${MOCK_PORT}/google-accounts`, GOOGLE_OAUTH_BASE_URL: `http://127.0.0.1:${MOCK_PORT}/google-oauth`, GOOGLE_PHOTOS_API_URL: `http://127.0.0.1:${MOCK_PORT}/google-picker`, PORT: "3200", HOSTNAME: "127.0.0.1", APP_URL: "http://localhost:3200", SMTP_HOST: "", RUN_WORKER: "true", NODE_ENV: "production", ADMIN_EMAIL: process.env.E2E_ADMIN_EMAIL ?? "e2e-admin@example.com" };
