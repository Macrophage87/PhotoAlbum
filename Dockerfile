...
# ffmpeg (Debian build, with libzimg for HDR tone mapping) transcodes uploaded clips.
RUN apt-get update && apt-get install -y --no-install-recommends tini ffmpeg && rm -rf /var/lib/apt/lists/*
