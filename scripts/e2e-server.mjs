...
const env = { ...process.env, DATABASE_URL: dbUrl,
  ...
  ANTHROPIC_BASE_URL: `http://127.0.0.1:${MOCK_PORT}`, ML_URL: `http://127.0.0.1:${MOCK_PORT}`, ML_TOKEN: "e2e-ml-token", ANTHROPIC_API_KEY: "sk-ant-e2e-dummy", ANNOTATION_ENABLED: "true", ANNOTATION_QUIET_MINUTES: "30", PHOTO_STORAGE_ROOT: photoRoot, PORT: "3200", HOSTNAME: "127.0.0.1", APP_URL: "http://localhost:3200", SMTP_HOST: "", RUN_WORKER: "true", NODE_ENV: "production", ADMIN_EMAIL: process.env.E2E_ADMIN_EMAIL ?? "e2e-admin@example.com" };
